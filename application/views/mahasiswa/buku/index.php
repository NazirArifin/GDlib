		...
		<div class="well span8">
			...
			<div class="navbar navbar-inner">
				...
				<form class="navbar-form pull-right">
					<input type="text" class="span2" id="cari" placeholder="cari buku disini...">
		...
		<br>
			<article class="post">
              <div class="post-header">
                <h2 class="post-title"><a href="">Bukuku yg pertama</a></h2>
                <div class="post-date">
                  <h4>1-Jan-13</h4>
                </div>
              </div>
            ...
            <article class="post">
				<div class="post-header">
					<h2 class="post-title"><a href="">Bukuku yg kedua</a></h2>
					<div class="post-date">
					  <h4>1-Jan-13</h4>
					</div>
				</div>
			...
			<article class="post">
				<div class="post-header">
					<h2 class="post-title"><a href="">Bukuku yg ketiga</a></h2>
					<div class="post-date">
					  <h4>1-Jan-13</h4>
					</div>
				</div>
    ...
    <div class="well span4">
  	...
  	<footer class="row-fluid footer">
		<div class="well span12">
			...
			<span>Created by: <a href="/creator" rel="tooltip" title="view creators">Lab Crew++</a>. <br />Copyright &copy; 2013. All rights reserved</span></center>
		</div>
	</footer>
</div>
